...
> _"Before MCP, I was translating. Now I'm composing. And that changes everything about how we can build automation."_
...
./scripts/quick-update.sh # Interactive update with Docker support
...
- [Node Update Guide](./docs/NODE_UPDATE_GUIDE.md) - Complete n8n node update process (NEW!)
